...
interface FoodAllergyDrawerProps {
  isOpen: boolean;
  onClose: () => void;
  items: FoodAllergy[];
        ...
        {list.map((opt, i) => {
          ...
          return (
            <div key={opt}
              ...
              className={`px-3 py-[7px] text-sm font-semibold cursor-pointer border-b border-[#F8FAFC] last:border-b-0 transition-colors ${i === rowHi ? "bg-blue-50 text-blue-700" : "hover:bg-[#F1F5F9] text-[#334155]"}`}
            >
              {isCreate ? (
      ...
      <div className="w-[88vw] max-w-[850px] h-full bg-white shadow-2xl flex flex-col overflow-hidden border-l border-[#E2E8F0]">
        ...
        <div className="px-5 py-4 border-b border-[#F1F5F9] flex items-center justify-between shrink-0 bg-[#FAFBFC]">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-sm font-extrabold text-[#1E293B]">Food/Other Allergy</span>
          </div>
        ...
        <div className="p-5 flex-1 flex flex-col space-y-4 overflow-y-auto min-h-0">
          ...
          <div className="flex-1 border border-[#E2E8F0] rounded-xl overflow-y-auto min-h-0 bg-[#FAFBFC]">
            <div className="flex items-stretch border-b border-[#E2E8F0] bg-white text-sm font-extrabold text-[#718096] uppercase sticky top-0 z-30 h-10">
              ...
              <div className="w-[30%] shrink-0 border-r border-[#E2E8F0] px-3 flex items-center">Name</div>
            ...
            {items.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-20 text-[#CBD5E0]">
                ...
                <span className="text-sm font-bold uppercase tracking-wider">No food allergies added yet</span>
              </div>
            ) : (
                  ...
                  >
                    ...
                    <div className="relative w-[22%] shrink-0 border-r border-[#E2E8F0] flex items-center">
                      <input type="text" value={item.status}
                        ...
                        placeholder="Status"
                        className="w-full h-full border-0 focus:ring-0 px-3 text-sm font-bold text-emerald-600 bg-transparent outline-none placeholder:text-slate-305"
                      />
