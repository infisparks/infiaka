      ...
      <nav className="flex-1 w-full flex flex-col gap-1.5 px-1 items-center">
        ...
        {onQueueClick ? (
          ...
          >
            ...
            <span className="text-[10px] font-bold mt-0.5 tracking-tight">Queue</span>
          </button>
        ) : (
          <Link
            href="/"
        ...
        {onBookClick ? (
          ...
          >
            ...
            <span className="text-[9.5px] font-bold mt-0.5 tracking-tight leading-none text-center">
              Book Appt
            </span>
          </button>
        ) : (
        ...
        >
          ...
          <span className="text-[8px] font-bold mt-0.5 tracking-tight leading-tight text-center">
            Upcoming Follow-up
          </span>
        </Link>
        ...
        >
          ...
          <span className="text-[9.5px] font-bold mt-0.5 tracking-tight">Payments</span>
        </Link>
        ...
        >
          ...
          <span className="text-[9.5px] font-bold mt-0.5 tracking-tight">Deleted</span>
        </Link>
      </nav>
