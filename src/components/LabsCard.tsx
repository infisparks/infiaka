    ...
    <section className="bg-white border border-[#E2E8F0] rounded-xl shadow-sm w-full select-none overflow-visible">
      ...
      <div className="flex justify-between items-center px-4 py-2.5 border-b border-[#F1F5F9]">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-bold text-[#1E293B] tracking-tight">Advised Investigations (Lab/Radiology)</span>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div ref={pkgDropdownRef} className="relative">
            ...
            >
              <span className="text-xs font-extrabold uppercase">TPanel</span>
            ...
            {showPkgDropdown && (
              <div className="absolute right-0 top-full mt-1.5 z-[100] bg-white border-2 border-yellow-100 rounded-xl shadow-2xl py-1.5 min-w-[240px] max-w-[280px] text-left overflow-hidden">
                <div className="px-3 py-1 bg-yellow-50/60 text-yellow-800 rounded-md text-xs font-extrabold uppercase tracking-wide mb-1 select-none mx-1">
                  Select Lab Package
                </div>
                {packages.map((pkg) => (
                  <div
                    key={pkg.id}
                    className="w-full text-left px-3 py-2 text-sm font-bold text-slate-700 hover:bg-yellow-50/50 hover:text-yellow-800 transition-colors border-b border-[#F8FAFC] last:border-0 flex items-center justify-between group cursor-pointer"
                  >
                    <div
                ...
                <div className="border-t border-slate-100 mt-1 pt-1.5 px-2">
                  <button
                    ...
                    className="w-full text-center px-3 py-2 text-xs font-extrabold text-yellow-800 bg-yellow-50/50 hover:bg-yellow-100/60 rounded-lg transition-colors cursor-pointer block border border-yellow-200"
                  >
      ...
      {/* Grid Column Headers */}
      <div className="flex items-stretch border-b border-[#E2E8F0] bg-slate-50/50 text-xs font-extrabold text-[#090d16] uppercase select-none">
      ...
      {toast && (
        <div className="fixed bottom-5 right-5 z-[200] bg-slate-900 text-white rounded-xl shadow-2xl p-3.5 px-4 flex items-center gap-2.5 max-w-sm transition-all animate-fade-in-up border border-slate-800">
          <div className={`w-5 h-5 rounded-full flex items-center justify-center text-xs font-extrabold shrink-0
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center z-[150] p-4 select-none animate-fade-in">
          <div className="bg-white rounded-2xl border border-slate-100 shadow-2xl p-5 w-full max-w-sm text-left">
            <div className="flex items-center gap-2.5 mb-3">
              ...
              <div>
                <h3 className="text-sm font-bold text-slate-800 leading-tight">Create Lab Package</h3>
                <p className="text-xs text-slate-400 font-bold leading-normal mt-0.5">
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full text-sm px-3 py-2 border border-slate-200 focus:outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-100 rounded-lg font-semibold placeholder:text-slate-350"
                />
              </div>
              ...
              <div>
                ...
                <div className="bg-slate-50 border border-slate-150 rounded-lg p-2 max-h-24 overflow-y-auto space-y-1">
                  {labs.map((l) => (
                    <div key={l.id} className="text-xs font-semibold text-slate-650 flex items-center gap-1.5">
              ...
              <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100">
                ...
                <button
                  ...
                  className="px-3.5 py-1.5 text-xs font-extrabold text-white bg-yellow-600 hover:bg-yellow-750 disabled:bg-slate-200 disabled:text-slate-400 rounded-lg transition-colors cursor-pointer flex items-center gap-1"
                >
        ...
        <div className="fixed inset-0 z-[1000] bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4 select-none">
          <div className="bg-white rounded-xl shadow-2xl border border-slate-200 w-full max-w-sm overflow-hidden animate-in fade-in zoom-in duration-150">
            <div className="p-4 bg-red-50 border-b border-red-100 flex items-center gap-3">
              ...
              <div>
                <h3 className="text-sm font-extrabold text-red-900 leading-tight">Delete Lab Package?</h3>
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100">
                <button
                  ...
                  className="px-3.5 py-1.5 text-xs font-bold text-slate-600 hover:text-slate-800 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={isDeletingPkg}
                  className="px-4 py-1.5 text-xs font-extrabold text-white bg-red-600 hover:bg-red-700 disabled:bg-slate-300 rounded-lg transition-colors cursor-pointer flex items-center gap-1 shadow-sm"
                >
