      ...
      <div className="w-[88vw] max-w-[850px] h-full bg-white shadow-2xl flex flex-col overflow-hidden border-l border-[#E2E8F0]">
        ...
        <div className="px-5 py-4 border-b border-[#F1F5F9] flex items-center justify-between shrink-0 bg-[#FAFBFC]">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-sm font-extrabold text-[#1E293B]">Other Medical History</span>
          </div>
        ...
        <div className="p-5 flex-1 flex flex-col space-y-4 overflow-y-auto min-h-0">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-extrabold text-[#64748B] uppercase tracking-wider">Enter Title:</label>
            <input
              type="text"
              placeholder="Enter title here"
              value={title}
              onChange={(e) => setTitle(e.target.value)}
              className="w-full h-10 px-4 border border-[#E2E8F0] focus:border-blue-400 focus:ring-1 focus:ring-blue-100 rounded-lg text-sm font-semibold text-[#1E293B] bg-[#FAFBFC] focus:bg-white focus:outline-none placeholder:text-[#C0CADC] transition-all"
            />
          </div>
          ...
          <div className="flex-1 border border-[#E2E8F0] rounded-xl overflow-y-auto min-h-0 bg-[#FAFBFC]">
            ...
            {items.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-20 text-[#CBD5E0]">
                ...
                <span className="text-sm font-bold uppercase tracking-wider">No records added yet</span>
              </div>
            ) : (
